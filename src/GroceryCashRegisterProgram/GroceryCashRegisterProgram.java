...
public class GroceryCashRegisterProgram {
    public static void main(String[] args) {
        ...
        float eggplantPrice = 5.99f;

        Scanner input = new Scanner(System.in);
        System.out.println("How much kilos of pears do you want : ");
        int pearAmount = input.nextInt();
        System.out.println("How much kilos of apples do you want : ");
        int appleAmount = input.nextInt();
        System.out.println("How much kilos of tomatoes do you want : ");
        int tomatoAmount = input.nextInt();
        System.out.println("How much kilos of bananas do you want : ");
        int bananaAmount = input.nextInt();
        System.out.println("How much kilos of eggplants do you want : ");
